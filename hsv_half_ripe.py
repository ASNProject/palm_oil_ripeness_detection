...
image = cv2.imread('assets/images/setengah_matang.jpg')
...
while True:
    ...
    data['setengah_matang']["LH"] = lh
    data['setengah_matang']["LS"] = ls
    data['setengah_matang']["LV"] = lv
    data['setengah_matang']["UH"] = uh
    data['setengah_matang']["US"] = us
    data['setengah_matang']["UV"] = uv
